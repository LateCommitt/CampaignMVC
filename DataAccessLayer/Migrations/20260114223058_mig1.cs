...
namespace DataAccessLayer.Migrations
{
    ...
    public partial class mig1 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    UserId = table.Column<int>(type: "int", nullable: false),
                    MonthlyDataGb = table.Column<int>(type: "int", nullable: false),
                    MonthlySpendTry = table.Column<int>(type: "int", nullable: false),
                    LoyaltyYears = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CampaignAssignments_UserId",
                table: "CampaignAssignments",
                column: "UserId");
